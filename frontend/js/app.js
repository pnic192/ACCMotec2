        ...
        $.ajax({
            ...
            success: function(data){
                ...
                switch (data.response){
                    case 'good' :
                            $('#uploadStatus').html('<p class="message success">' + data.message + 'and will be available in the next few minutes.</p>');
                    ...
                    case 'bad' :
                        ...
                        break;
                    case 'part' :
                            $('#uploadStatus').html('<p class="message info">Some issues - ' + data.message + '</p>');
                            console.log("|" + data.message + "|");
